...
import { LEGAL_CA_DATA } from '../data/legalCaData';
import { ConsultationModal } from '../components/ConsultationModal';
import { AskGrowthoraModal } from '../components/AskGrowthoraModal';

export default function LegalCaDetailPage() {
  const { serviceSlug } = useParams();
  const navigate = useNavigate();
  const detailData = LEGAL_CA_DATA[serviceSlug];
    ...
    return (
      <div className="services-page-root">
        ...
        <div style={{ padding: '200px 20px', textAlign: 'center', minHeight: '60vh' }}>
          <h2>Legal & CA Service Not Found</h2>
          <p>The requested Legal & CA service does not exist.</p>
          <button className="btn-primary" onClick={() => navigate('/services/legal-ca')}>
            Return to Legal & CA Services
          </button>
        </div>
        <Footer />
      </div>
    ...
    <div className="service-detail-root">
      ...
      <section className="sd-hero">
        <div className="sd-container">
          <button className="back-btn-ghost" onClick={() => navigate('/services/legal-ca')}>
            <ArrowLeft size={16} /> Back to Legal & CA Services
          </button>
        ...
        <div className="sd-container">
          <div className="sd-content-grid">
            ...
            <div className="sd-main-content">
              ...
              {/* Documents Required */}
              <h2>Required Documents & Credentials</h2>
              <ul className="sd-check-list">
      ...
      <ConsultationModal
        ...
        selectedService={{ title: detailData.title, category: 'LEGAL & CA' }}
      />
